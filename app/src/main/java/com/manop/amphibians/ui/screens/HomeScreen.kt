package com.manop.amphibians.ui.screens
...
import com.manop.amphibians.R
import com.manop.amphibians.network.Amphibian
import com.manop.amphibians.ui.theme.AmphibiansTheme
...
fun HomeScreen(
    ...
    contentPadding: PaddingValues = PaddingValues(dimensionResource(R.dimen.zero_space))
) {
    when (amphibiansUiState) {
        is AmphibiansUiState.Loading -> LoadingScreen(modifier.size(dimensionResource(R.dimen.screen_size)))
...
fun LoadingScreenPreview() {
    AmphibiansTheme {
        LoadingScreen(
            Modifier
                .fillMaxSize()
                .size(dimensionResource(R.dimen.screen_size))
        )
    }
}
